...
class _MoodTrackingScreenState extends State<MoodTrackingScreen> {
  ...
  String _getMoodText(int rating) {
    switch (rating) {
      ...
      default: return "How was your mood today?"; // Default text before selection
    }
  }
 ...
 Color _getBackgroundColor(int rating) {
     switch (rating) {
      ...
      default: return Colors.grey.shade300; // Default background before selection
    }
  }
  ...
  Widget _getMoodFaceWidget(int rating) {
    ...
    if (imagePath == null) {
      ...
      return SizedBox(
        height: 180, // Match the image container height
        child: Center(child: Icon(Icons.error_outline, size: 60, color: Colors.redAccent))
      );
    }
    ...
    return Container(
      ...
      child: Image.asset(
        ...
        errorBuilder: (context, error, stackTrace) {
          ...
          return Center(child: Icon(Icons.broken_image, size: 60, color: Colors.redAccent));
        },
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    Color textColor = ThemeData.estimateBrightnessForColor(currentBackgroundColor) == Brightness.dark
        ? Colors.white
        : Colors.black;
    ...
    return Scaffold(
      ...
      body: AnimatedContainer(
        duration: const Duration(milliseconds: 400), // Slightly slower transition
        color: currentBackgroundColor,
        child: SafeArea(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.spaceBetween, // Pushes content to top/bottom
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      tooltip: 'Close',
                      onPressed: () => Navigator.pop(context), // Or specific close logic
                    ),
                  ],
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        _selectedRating == 0 ? 'How was your mood today?' : _getMoodText(_selectedRating),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: _selectedRating == 0 ? 28 : 32, // Make text larger when selected
                       ...
                       children: List.generate(5, (index) {
                         ...
                         return IconButton(
                           ...
                           icon: Icon(
                             ...
                             color: Colors.cyan.shade300, // Consistent star color
                           ),
                           onPressed: () {
                             setState(() {
                               _selectedRating = currentStar;
                       ...
                       child: _selectedRating > 0
                         ? ElevatedButton(
                             ...
                             onPressed: () async { // Make onPressed async
                               print('Mood selected: $_selectedRating stars');
                         ...
                         : SizedBox(height: 60), // Maintain space when button is hidden
                      ),
