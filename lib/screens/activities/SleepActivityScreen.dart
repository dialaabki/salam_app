...
class _SleepActivityScreenState extends State<SleepActivityScreen> {
  ...
  final Map<String, String> soundImages = {
    'Gentle rain with soft thunder': 'assets/images/rain_icon.png', // Replace path
    'Soft wind blowing through trees': 'assets/images/wind_icon.png', // Replace path
    'Synth-based atmospheric music': 'assets/images/music_icon.png', // Replace path
  };
          ...
          Positioned.fill(
            child: Image.asset(
              ...
              errorBuilder: (context, error, stackTrace) {
                print("Error loading image: assets/images/sleep_bg.png, $error");
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: primaryTextColor,
                       shadows: [ Shadow(blurRadius: 2.0, color: Colors.black.withOpacity(0.4), offset: Offset(1, 1))],
                    ),
                  ),
                  SizedBox(height: 30),
                  Text(
                  ...
                  SizedBox(height: 25),
                  Column(
                    children: soundFiles.keys.map((sound) {
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected ? choiceButtonBackgroundColor.withOpacity(1.0) : choiceButtonBackgroundColor.withOpacity(0.9),
                              borderRadius: BorderRadius.circular(18.0),
                              border: isSelected
                            ...
                            child: Row(
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.asset(
                                    soundImages[sound] ?? 'assets/images/default_icon.png',
                                    height: 45,
                                    width: 45,
                                    fit: BoxFit.cover,
                                    errorBuilder: (context, error, stackTrace) {
                                      print("Error loading image: ${soundImages[sound]}, Error: $error");
                                      return Container(
                                       height: 45, width: 45,
                                       decoration: BoxDecoration(
  ...
  void initState() {
    ...
    _positionSubscription = audioPlayer.onPositionChanged.listen((newPosition) {
     ...
     _playerCompleteSubscription = audioPlayer.onPlayerComplete.listen((event) {
       if (mounted) setState(() { _position = _duration; _playerState = PlayerState.completed; });
     });
    _playSound();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new, color: backButtonColor), // Use consistent icon
          tooltip: 'Back',
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(_formatTime(_position), style: const TextStyle(color: Colors.white)),
